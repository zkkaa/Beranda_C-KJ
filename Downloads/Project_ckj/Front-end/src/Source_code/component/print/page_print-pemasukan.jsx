...
export default function PagePrintPemasukan({ DataTransaksi }) {
        ...
        <div className="print_page">
              ...
              <div class="page_print_pem">
                  ...
                  <div class="div_harga_print">
                    <div class="jumlah_barangjasa">
                      <div class="tagihan_print">
                        <span>Rp. </span>
                        <span class="harga_print_pem">{item.Harga_Satuan}</span>
                      </div>
                ...
                <div class="total_bayar_print">
                  ...
                  <div class="span_diskon">
                    ...
                    <div class="right">
                      <span>Rp. </span>
                      <span className="diskon_print_pem">{item.Diskon}</span>
                    </div>
                  </div>
                  <div class="span_pajak">
                    ...
                    <div class="right">
                      <span>Rp. </span>
                      <span className="pajak_print_pem">{item.Pajak}</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="btn-detail-print">
            <Link to={"/Rekap/Rekap_pemasukan"}>
              <input type="reset" className="kembali" value={"Batal"} />
            </Link>
