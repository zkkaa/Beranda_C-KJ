...
export default function InputTransaksi_Layanan({ total, Cart }) {
  ...
  function KirimData(e) {
    ...
    axios
      .post(`${import.meta.env.VITE_API_URL}/Transaksi/pemasukanLayanan`, {
        filteredResults,
        newItem,
        Cart,
      })
    ...
    axios
      .post(`${import.meta.env.VITE_API_URL}/dataStokLayanan`, { Cart })
      .then((res) => {
        console.log(res);
      });
